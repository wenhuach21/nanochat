...
from nanochat.checkpoint_manager import save_checkpoint, load_checkpoint, export_gpt_to_transformers
...
parser.add_argument("--save-hf", type=int, default=1, help="also export a transformers-loadable folder (hf_<step>/ with config.json+safetensors+tokenizer) at every save point (1=yes, 0=no)")
# Output
